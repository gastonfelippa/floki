...
class CreateFacturasCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facturas_copy', function (Blueprint $table) {
            $table->id();            
            ...
            $table->enum('forma_de_pago', ['1','2','3','4','5','6'])->nullable(); //efectivo,tarj débito,tarj crédito,transferencia,cheque,cta cte
            $table->enum('mercadopago', ['0','1'])->nullable(); //no,si
            $table->string('nro_comp_pago')->nullable();        //nro ticket tarjeta, transferencia o cheque 
    ...
    {
        Schema::dropIfExists('facturas_copy');
    }
}

...
class CardsHomeController extends Component
{
    ...
    public function render()
    {
        ...
        $infoProductosCompra = [];
        $infoProdCompra = Producto::where('tipo', 'like', 'Art. Compra')
            ->where('comercio_id', $this->comercioId)
            ->where('controlar_stock', 'si')
            ->orWhere('tipo', 'like', 'Art. Compra/Venta')
            ->where('comercio_id', $this->comercioId)
            ->where('controlar_stock', 'si')
        ...
        $infoProductosVenta = [];
        $infoProdVenta = Producto::where('tipo', 'like', 'Art. Compra/Venta')
            ->where('comercio_id', $this->comercioId)
            ->where('controlar_stock', 'si')
            ->orWhere('tipo', 'like', 'Art. Venta c/receta')
            ->where('comercio_id', $this->comercioId)
            ->where('controlar_stock', 'si')
            ->select('id', 'descripcion')
            ->get();

...
<head>
    ...
    <title>Floki - Panel de Administración</title>
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <!--  BEGIN NAVBAR  -->
    <div class="header-container mb-2" style="background-color: #666666;">

<div class="modal fade" id="modalAddLocalidad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">                          
                            <div class="form-group col-6">
                                <div class="input-group">
                                    ...
                                    <input id="localidad" type="text" class="form-control text-capitalize" placeholder="Localidad" autofocus autocomplete="off">
                                </div>                             
                            </div>
                            <div class="form-group col-6">
                                <div class="input-group">
                                    ...
                                    <select id="provincia" class="form-control text-center">

        ...
        <div class="row mt-3">                               
            <div class="col-12 col-md-4 layout-spacing">
                <div class="input-group">
                    ...
                    <input id="name" type="text" class="form-control text-capitalize" placeholder="Nombre" wire:model.lazy="name">
                </div>
            </div>
            <div class="col-12 col-md-4 layout-spacing">
                <div class="input-group">
                    ...
                    <input id="apellido" type="text" class="form-control text-capitalize" placeholder="Apellido" wire:model.lazy="apellido">
                </div>
            </div>
            <div class="col-12 col-md-4 layout-spacing">
                <div class="input-group">
        ...
        <div class="row">
            <div class="col-12 col-md-4 layout-spacing">
                <div class="input-group ">
                    ...
                    <input type="text" class="form-control" placeholder=Teléfono wire:model.lazy="telefono1">
                </div>
            </div>
            <div class="col-12 col-md-4 layout-spacing">
                <div class="input-group ">

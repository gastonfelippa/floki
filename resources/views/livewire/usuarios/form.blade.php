    ...
    <div class="col-sm-12 col-md-10 layout-spacing">
        <div class="widget-content-area">
            ...
            <div class="widget-one">
                <h5><b>@if($selected_id ==0) Crear Nuevo Empleado  @else Editar Empleado @endif</b></h5>
                <div class="row mt-3">                               
                    <div class="col-12 col-md-4 layout-spacing">
                        <div class="input-group">
                            ...
                            <input id="name" type="text" class="form-control text-capitalize" placeholder="Nombre" wire:model.lazy="name" onblur="validarNombre()" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-12 col-md-4 layout-spacing">
                        <div class="input-group">
                            ...
                            <input id="apellido" type="text" class="form-control text-capitalize" placeholder="Apellido" wire:model.lazy="apellido" onblur="validarApellido()" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-12 col-md-4 layout-spacing">
                        <div class="input-group">
                            ...
                            <input id="documento" type="text" class="form-control" placeholder="Doc. N°" wire:model.lazy="documento" onblur="verificarPorDni()" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">                               
                    ...
                    <div class="col-12 col-md-4 layout-spacing">
                        <div class="input-group ">
                            ...
                            <select wire:model="localidad" class="form-control text-capitalize">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 layout-spacing">
                        <div class="input-group ">
                            ...
                            <input type="text" class="form-control" placeholder=Teléfono wire:model.lazy="telefono1" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-6 col-md-3 layout-spacing">
                        <div class="input-group ">
                            ...
                            <input wire:model.lazy="fecha_nac" type="text" class="form-control flatpickr flatpickr-input active" placeholder="Fecha Nacimiento" autocomplete="off">                       
                        </div>
                    </div>
                    <div class="col-6 col-md-3 layout-spacing">
                        <div class="input-group ">
                            ...
                            <input wire:model.lazy="fecha_ingreso" type="text" class="form-control flatpickr flatpickr-input active" placeholder="Fecha Ingreso" autocomplete="off">                       
                        </div>
                    </div>
                    <div class="col-6 col-md-3 layout-spacing">
                        <div class="input-group ">
                ...
                <div class="row">                    
                    <div class="col-6 col-md-6 layout-spacing">
                        <div class="input-group ">
                            <div class="input-group-prepend">
                            ...
                            <input wire:model.lazy="email" type="text" class="form-control" placeholder="correo@gmail.com" autocomplete="off">                       
                        </div>
                    </div>
                    <div class="col-6 col-md-3 layout-spacing">
                        <div class="input-group ">
                            ...
                            <div class="input-group-append">
                                    <span class="input-group-text" onclick="openModalCategoria()">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></svg></span>                             			               
                            </div>
                        </div>
                    </div>

<div class="modal fade" id="modalAddLocalidad" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
                            ...
                            <div class="row">                          
                                <div class="form-group col-6">
                                    <div class="input-group">
                                        ...
                                        <input id="localidad" type="text" class="form-control text-capitalize" placeholder="Localidad" autocomplete="off" autofocus>
                                    </div>                             
                                </div>
                                <div class="form-group col-6">
                                    <div class="input-group">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" type="button" onclick="save()">Guardar</button>
            </div>
        </div>
    </div>
</div>

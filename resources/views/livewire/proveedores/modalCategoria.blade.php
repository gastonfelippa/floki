<div class="modal fade" id="modalAddCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                        ...
                        <div class="row">                          
                            <div class="form-group col-12">
                                <div class="input-group">
                                    ...
                                    <input id="descripcion_cat" type="text" class="form-control text-capitalize" placeholder="Descripción" autocomplete="off" autofocus>
                                </div>                             
                            </div>
                        </div>
                            <div class="row">
                                <div class="form-group col-12">
                                    <h6>Elija el Tipo de Gasto</h6>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="checks" checked>
                                        <label class="form-check-label gastoFijo" for="inlineRadio1">Gasto Fijo</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="checks">
                                        <label class="form-check-label" for="inlineRadio2">Gasto Variable</label>
                                    </div>
                                </div>
                            </div>
                    </form>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="saveCategoria()">Guardar</button>
        </div>
    </div>
</div>
</div>
<div class="col-12 layout-spacing">
	...
	<div class="widget-content-area">
        <div class="widget-one">
            <h5><b>@if($selected_id ==0) Nuevo Proveedor @else Editar Proveedor @endif</b></h5> 
            <div class="row mt-3">                               
                <div class="col-12 col-md-4 layout-spacing">
                    <div class="input-group">
                        ...
                        <input id="nombre" type="text" class="form-control text-uppercase" placeholder="Nombre/Empresa" wire:model.lazy="nombre_empresa" autofocus autocomplete="off">
                    </div>
                </div>
                <div class="col-12 col-md-3 layout-spacing">
                    <div class="input-group ">
                        ...
                        <select wire:model="condIvaId" class="form-control">
                            <option value="Elegir">Condición de IVA</option>
                            @foreach($condIva as $c)
                            <option value="{{ $c->id }}">
                                  {{$c->descripcion}}
                            </option>                                       
                            @endforeach 
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" onclick="openModalIva()">
                ...
                <div class="col-12 col-md-2 layout-spacing">
                    <div class="input-group">
                        ...
                        <input id="cuit" type="text" class="form-control" placeholder="CUIT N°" wire:model.lazy="cuit">
                    </div>
                </div>
                <div class="col-12 col-md-3 layout-spacing">
                    <div class="input-group ">
            ...
            <div class="row">
                ...
                <div class="col-5 col-md-2 layout-spacing">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder=N° wire:model.lazy="numero">
                    </div>
                </div>
                <div class="col-12 col-md-3 layout-spacing">
                    <div class="input-group ">
                ...
                <div class="col-12 col-md-3 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" placeholder=Teléfono/Empresa wire:model.lazy="tel_empresa">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4 layout-spacing">
                    <div class="input-group">
                        ...
                        <input id="nombre_contacto" type="text" class="form-control text-uppercase" placeholder="Nombre/Contacto" wire:model.lazy="nombre_contacto">
                    </div>
                </div>
                <div class="col-12 col-md-4 layout-spacing">
                    <div class="input-group">
                        ...
                        <input id="apellido_contacto" type="text" class="form-control text-uppercase" placeholder="Apellido/Contacto" wire:model.lazy="apellido_contacto">
                    </div>
                </div>
                <div class="col-12 col-md-4 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" placeholder=Teléfono/Contacto wire:model.lazy="tel_contacto">
                    </div>
                </div>               
            </div>
            <div class="row">

<div class="modal fade" id="modalAddCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title">Agregar Categoría de Gasto</h5>
        </div>
                        ...
                        <div class="row">                          
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="descripcion_cat" type="text" class="form-control text-capitalize" placeholder="Descripción">
                                </div>                             
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="saveCategoria()">Guardar</button>
        </div>
    </div>
</div>
</div>
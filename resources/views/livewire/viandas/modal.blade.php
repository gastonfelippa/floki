<div class="modal fade" id="modalVianda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <div class="widget-content-area">
                <div class="widget-one">
                    <form>
                        <div class="row">                          
                            <input id="cliente_id" type="text" class="form-control" placeholder="Cantidad">
                            ...
                            <div class="form-group col-6">
                                <div class="input-group">
                                    ...
                                    <select id="producto" class="form-control text-center">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveVianda" type="button" onclick="save()">Guardar</button>
        </div>
    </div>
</div>
</div>
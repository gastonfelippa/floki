...
<div class="container-fluid" style="color:#fff">
    <div class="row justify-content-center">
        <h3 class="mt-5 text-center col-sm-12 col-md-8 color">LO SIENTIMOS MUCHO...<br>TU SISTEMA ESTÁ SUSPENDIDO MOMENTÁNEAMENTE 
            PORQUE EL PERÍODO DE PRUEBA HA FINALIZADO</h3>
        <h2 class="mt-2 text-center col-sm-12 col-md-8 color">Para continuar debes contactarte con el Administrador del Sistema
            para solicitar la suscripción a alguno de sus planes...<br>¡Muchas gracias!
        </h2>
    </div>

...
<div class="container-fluid" style="color:#fff">
    <div class="row justify-content-center">
        <h3 class="mt-5 text-center col-sm-12 col-md-8 color">ATENCIÓN!!!<br>TU PLAN ESTÁ EN MORA...</h3>
        <h2 class="mt-2 text-center col-sm-12 col-md-8 color">Debes regularizar tu situación porque en los 

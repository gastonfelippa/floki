<div class="col-sm-12 col-md-6 layout-spacing">
	...
	@include('common.messages') 
        <div class="widget-one">
            <h5><b>@if($selected_id ==0) Nueva Asignación De Caja  @else Editar Asignación De Caja @endif</b></h5>
            <div class="row mt-3">  
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <select wire:model="caja" class="form-control text-center">
                ...
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <select wire:model="usuario" class="form-control text-center">
            ...
            <div class="row">
                <div class="col-12 layout-spacing">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="0" wire:model="habilitar">
                        <label class="form-check-label" for="inlineRadio2">Deshabilitar</label>
                    </div>
                    @else
                    <div>
                    ...
                    <!-- <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" wire:model="habilitar">
                        <label class="form-check-label" for="inlineRadio1">Habilitar</label>
                    </div> -->
                    @endif
                </div>
            </div>
            <div class="row">                               
                <div class="col-12 layout-spacing text-right">

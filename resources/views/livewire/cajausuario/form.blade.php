	...
	<div class="widget-content-area">
        <div class="widget-one">	
            ...
            <div class="row mt-3">  
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        @if($edit == 2)
                        <select wire:model="caja" class="form-control text-center" disabled>
                        @else
                ...
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        @if($edit == 2)
                        <select wire:model="usuario" class="form-control text-center" disabled>
                        @else
            ...
            @else
                ...
                <div class="col-6 col-sm-3 layout-spacing mt-1">
                    @if($edit == 0)
                        <button type="button" wire:click="StoreOrUpdate()" class="btn btn-danger btn-block">
                            HABILITAR
                        </button>

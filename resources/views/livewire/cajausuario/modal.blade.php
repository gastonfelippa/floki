<div class="modal fade" id="modalAddCaja" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">                          
                            <div class="form-group col-12">
                                <div class="input-group">
                                    ...
                                    <input id="descripcion" type="text" class="form-control text-capitalize" placeholder="Descripción" autocomplete="off" autofocus>
                                </div>                             
                            </div>
                        </div>
                        <!-- <div class="row">                          

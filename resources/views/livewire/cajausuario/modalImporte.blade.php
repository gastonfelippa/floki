<div class="modal fade" id="modalEditImporte" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="saveEdit()">Guardar</button>
        </div>
    </div>
</div>
</div>
<script>
    $('#modalEditImporte').on('shown.bs.modal', function () {

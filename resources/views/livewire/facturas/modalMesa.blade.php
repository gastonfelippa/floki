<div class="modal fade" id="modalMesa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                        ...
                        <div class="row">   
                            <div class="form-group col-6">
                                <div class="input-group">
                                    ...
                                    <select id="mesa" class="form-control text-center">
                            ...
                            <div class="form-group col-6">
                                <div class="input-group">
                                    ...
                                    <select id="mozo" class="form-control text-center">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="abrirMesa()">Abrir</button>
        </div>
    </div>
</div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row">
                    <div class="col-6">
                        @if($modConsignaciones == "1" && $lista == "3")
                            <h5 class="modal-title mr-4">Consignatarios</h5>
                        @else
                            <h5 class="modal-title">Clientes</h5>
                        @endif
                    </div>
                    <div class="col-6">
                        <button class="btn btn-danger btn-sm" onclick="agregarCliente()">Agregar</button>
                    </div>
                </div>                
            </div>       
                            ...
                            <div class="row">   
                                <div class="form-group col-12">
                                    <div class="input-group">
                                        ...
                                        @if($modConsignaciones == "1" && $lista == "3")
                                            <select id="cli" class="form-control text-left">
                                                <option value="Elegir">Consignatario</option>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="saveCliente()">Guardar</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                            ...
                            <div class="row">                          
                                <div class="form-group col-6">
                                    <div class="input-group">
                                        ...
                                        <input id="descripcion" type="text" class="form-control text-capitalize" placeholder="Banco" autocomplete="off">
                                    </div>                             
                                </div>
                                <div class="form-group col-6">
                                    <div class="input-group">
                                        ...
                                        <input id="sucursal" type="text" class="form-control text-capitalize" placeholder="Sucursal" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="guardarBanco()">Guardar</button>
            </div>
        </div>
    </div>
</div>
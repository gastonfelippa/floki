<div class="modal fade" id="modalCtacte" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                        ...
                        <div class="row">   
                            <div class="form-group col-12">
                                <div class="input-group">
                                    ...
                                    <select id="cliente2" class="form-control text-left">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary saveTarifa" type="button" onclick="saveCtacte()">Guardar</button>
        </div>
    </div>
</div>
</div>
                ...
                <form> 
                    <div class="row">
                        <div class="form-group col-md-5 col-sm-12 ">                       
                            ...
                            <select wire:model="proveedor" class="form-control form-control-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6"> 
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            ...
                            @else
                                <button type="button" wire:click.prevent="modificarEncabezado()" onclick="setfocus('barcode')" 
                        ...
                        <!-- <span class="badge badge-primary ml-4 mt-1"
                ...
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            ...
                            <input wire:model.lazy="precio" type="text" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="row ">

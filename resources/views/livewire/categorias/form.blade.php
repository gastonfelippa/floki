            ...
            <div class="row mt-3">                               
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input id="nombre" type="text" class="form-control text-uppercase" wire:model="descripcion" autofocus autocomplete="off">
                    </div>
                </div>            
                <div class="col-12 col-md-6 layout-spacing">
                    <label >Rubro</label>
            ...
            <div class="row"> 
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" wire:model="margen_1">
                    </div>
                </div>
                <div class="col-12 col-md-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control" wire:model="margen_2">
                    </div>
                </div>
            </div>
            <div class="row">

<div class="col-sm-12 col-md-4 layout-spacing">
	...
	<div class="widget-content-area">
        <div class="widget-one">
            <h5><b>@if($selected_id ==0) Nueva Mesa  @else Editar Mesa @endif</b></h5>
            <div class="row mt-3">                               
                <div class="col-12 layout-spacing">
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input id="capacidad" name="capacidad" type="text" class="form-control text-uppercase" placeholder="Capacidad" wire:model="capacidad" autofocus autocomplete="off">
                    </div>
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                        ...
                        <select wire:model="sector" class="form-control">
                            <option value="Elegir">Sector</option>
                            @foreach($sectores as $l)
                            <option value="{{ $l->id }}">
                                {{$l->descripcion}}
                            </option>                                       
                            @endforeach 

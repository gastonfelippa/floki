<div class="col-sm-12 col-md-5 layout-spacing">    
    <div class="widget-content-area">
        <div class="widget-one">
            ...
            <h5><b>@if($selected_id ==0) Nuevo Débito  @else Editar Débito @endif</b></h5>
            <div class="row mt-3">                               
            ...
            <div class="row mt-3">
                <div class="col-12 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input id="importe" name="importe" type="text" class="form-control text-capitalize" placeholder="Importe" wire:model="importe" autofocus autocomplete="off">
                    </div>
                </div>
            </div>

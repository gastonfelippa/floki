<div class="col-sm-12 col-md-6 layout-spacing">    
    <div class="widget-content-area">
        <div class="widget-one">
            ...
            <h5><b>@if($selected_id ==0) Nuevo Banco  @else Editar Banco @endif</b></h5>
            <div class="row mt-3">                               
                <div class="col-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input id="descripcion" name="nombre" type="text" class="form-control text-uppercase" placeholder="Banco" wire:model="descripcion" autofocus autocomplete="off">
                    </div>
                </div>
                <div class="col-6 layout-spacing">
                    <div class="input-group ">
                        ...
                        <input id="sucursal" name="nombre" type="text" class="form-control text-capitalize" placeholder="Sucursal" wire:model="sucursal" autofocus autocomplete="off">
                    </div>
                </div>
            </div>

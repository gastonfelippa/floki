<div class="modal fade" id="modalNroComprobanteDePago" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
                        ...
                        <div class="row">                          
                            <div class="form-group col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="nroCompPago" class="form-control" placeholder="Ingrese el N° del Comprobante de Pago">
                                </div>                             
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" onclick="guardarDatosPago()" data-dismiss="modal" type="button">Guardar</button>
        </div>
    </div>
</div>
</div>
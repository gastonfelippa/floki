...
<div class="modal fade" id="modalMozo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Asignar Mozo</h5>
            </div>       
            ...
            <div class="modal-footer">
                <button id="btnCancelar" class="btn btn-dark" onclick="salir()"></i>Cancelar</button>
                <button class="btn btn-primary" type="button" onclick="asignarMozo()">Abrir</button>
            </div>
        </div>
    </div>
</div>

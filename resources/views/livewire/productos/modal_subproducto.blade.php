<div class="modal fade" id="modal_subproducto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <input type="hidden" id="id_subproducto">
                    ...
                    <div class="widget-one">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input id="texto_sp" type="text" class="form-control text-capitalize" placeholder="Ingrese un texto" autocomplete="off">
                            </div>                             
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <input id="stock_actual_sp" type="text" class="form-control">
                        </div>
                        <div class="form-group col-4">
                            <label >Stock Ideal</label>
                            <input id="stock_ideal_sp" type="text" class="form-control">
                        </div>     
                        <div class="form-group col-4">
                            <label >Stock Mínimo</label>
                            <input id="stock_minimo_sp" type="text" class="form-control">
                        </div>     
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="save_sp()">Guardar</button>
            </div>
        </div>
    </div>
</div>
